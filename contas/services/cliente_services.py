...
def transferir_valor(conta_origem_numero, conta_destino_numero, valor):
    ...
    Transacao.objects.create(conta=conta_origem, tipo='Transferência enviada', valor=valor_decimal)
    Transacao.objects.create(conta=conta_destino, tipo='Transferência recebida', valor=valor_decimal)
